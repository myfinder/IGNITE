...
# 2. Set up environment variables (API keys, etc.)
...
Interactively generates the environment variable file used by the systemd service.
...
**Generated file:** `~/.config/ignite/env`
...
> **⚠️ Security:** This file contains API keys. Always set `chmod 600`.
...
| `CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS` | — | Enable team features | `1` |
