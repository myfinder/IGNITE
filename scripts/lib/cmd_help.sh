...
cmd_help() {
    ...
    case "$command" in
        ...
        service)
            ...
            echo "  setup-env            環境変数ファイルを対話的に生成"
            echo "  help                 このヘルプを表示"
            echo ""
            echo "オプション:"
            ...
            echo "  2. ignite service setup-env        # 環境変数設定"
            ...
            echo ""
            echo "注意:"
            echo "  install は PR2（systemdテンプレートユニット追加）マージ後に使用可能です。"
            echo "  現時点では ignite start --daemon でdaemonモードをご利用ください。"
            echo ""
            echo "例:"
